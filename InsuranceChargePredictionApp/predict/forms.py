...
class PredictionForm(forms.Form):
    ...
    weight = forms.FloatField(label='Poids (en kg) :', min_value=30, max_value=250, required=True)
    height = forms.FloatField(label='Taille (en m) :', min_value=1, max_value=2.50, required=True)
